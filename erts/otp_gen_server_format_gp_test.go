// Code generated by goplus from otp_gen_server_format_test.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
func TestPinnedOTPGenServerFormatting(t *testing.T) {
	...
	for lineNumber, line := range strings.Split(strings.TrimSpace(string(payload)), "\n") {
		...
		function := fields[1]
		if function == "status_callback_legacy" {
			module = "gen_server_format_legacy_callbacks"
			function = "status_callback"
		}
		var process *VMProcess
		switch __gp_m0 := any(modules.Invoke(module, function, []term.Term{}, clock.Real{}, registry)).(type) {
...
func pinnedGenServerFormatModules(t *testing.T) *ModuleSet {
	...
	for _, path := range []string{"testdata/otp-29.0.4/gen_server_format_callbacks.beam", "testdata/otp-29.0.4/gen_server_format_legacy_callbacks.beam"} {
		switch __gp_m3 := any(LoadModuleFile(read, path, ModuleLoaderConfig{})).(type) {
