// Code generated by goplus from otp_gb_trees_callbacks_differential_test.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
func TestPinnedOTPGbTreesCallbackDifferentialCorpus(t *testing.T) {
	...
	switch __gp_m0 := any(LoadModuleFile(read, "testdata/otp-29.0.4/gb_trees_callbacks.beam", ModuleLoaderConfig{})).(type) {
	...
	switch __gp_m1 := any(NewModuleSet([]*LoadedModule{pinnedGbTreesModule(t), pinnedListsModule(t), pinnedStdlibDependency(t, "orddict"), callback})).(type) {
	...
	for lineNumber, line := range strings.Split(strings.TrimSpace(string(payload)), "\n") {
		...
		switch __gp_m3 := any(modules.Invoke("gb_trees_callbacks", fields[1], arguments, clock.Real{}, registry)).(type) {
