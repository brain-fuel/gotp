// Code generated by goplus from otp_gen_statem_export_coverage_test.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
func TestPinnedOTPGenStatemExportLedgerCoverage(t *testing.T) {
	...
	if module.digest != "29a48bbb1ce7da252ddafc5c7de34c083b981cbbfd858a152ebacf2d1ef497e9" {
		t.Fatalf("gen_statem digest = %s", module.digest)
	}
	...
	for _, item := range wire.Items {
		ledger[item.Capability] = item.Status
	}
	...
	for export := range module.exports {
		if _, classified := metadata[export]; classified {
			continue
		}
	...
	if len(module.exports) != 42 {
		t.Fatalf("gen_statem exports = %d, want 42", len(module.exports))
	}
}
