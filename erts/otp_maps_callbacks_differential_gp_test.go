// Code generated by goplus from otp_maps_callbacks_differential_test.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
func TestPinnedOTPMapsCallbackDifferentialCorpus(t *testing.T) {
	...
	switch __gp_m0 := any(LoadModuleFile(read, "testdata/otp-29.0.4/maps_callbacks.beam", ModuleLoaderConfig{})).(type) {
	...
	switch __gp_m1 := any(NewModuleSet([]*LoadedModule{pinnedMapsModule(t), pinnedListsModule(t), callback})).(type) {
	...
	for lineNumber, line := range strings.Split(strings.TrimSpace(string(payload)), "\n") {
		...
		switch __gp_m3 := any(modules.Invoke("maps_callbacks", fields[1], arguments, clock.Real{}, registry)).(type) {
