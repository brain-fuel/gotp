-module(gen_statem_format_handle_event_callbacks).
...
-export([init/1, callback_mode/0, handle_event/4, format_status/1]).
...
status_normal() -> gen_statem_format_fixture:status(?MODULE, statem_format_he_normal, false).
status_suspended() -> gen_statem_format_fixture:status(?MODULE, statem_format_he_suspended, true).
status_callback() -> gen_statem_format_fixture:status_callback(?MODULE, statem_format_he_callback).
status_callback_malformed() ->
    gen_statem_format_fixture:status_callback_malformed(?MODULE, statem_format_he_malformed).
status_callback_legacy() ->
    gen_statem_format_fixture:status_legacy(gen_statem_format_handle_event_legacy_callbacks,
                                            statem_format_he_legacy).
