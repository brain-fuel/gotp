-module(gen_statem_async_state_functions_callbacks).
...
-export([init/1,callback_mode/0,idle/3]).
...
init([])->gen_statem_async_fixture:init(). callback_mode()->state_functions. idle(T,E,D)->gen_statem_async_fixture:event(T,E,idle,D).
