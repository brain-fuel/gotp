// Code generated by goplus from otp_gen_server_enter_loop_test.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
func TestPinnedOTPGenServerEnterLoop(t *testing.T) {
	...
	for lineNumber, line := range strings.Split(strings.TrimSpace(string(payload)), "\n") {
		...
		switch __gp_m2 := any(modules.Invoke("gen_server_enter_loop_callbacks", fields[1], []term.Term{}, clock.Real{}, registry)).(type) {
